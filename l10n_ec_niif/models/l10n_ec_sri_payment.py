...
class L10n_ecSriPaymentMethod(models.Model):
    ...
    _sql_constraints = [
        ('code_uniq', 'unique (code)', 'Code of Payment Method must be unique, please review!')]

    def _name_search(self, name, args=None, operator='ilike', limit=100, name_get_uid=None):
        args = args or []
        res = super(L10n_ecSriPaymentMethod, self)._name_search(name, args, operator, limit, name_get_uid)
        if not res and name:

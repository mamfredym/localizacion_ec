...
class TaxSupport(models.Model):
    ...
    code = fields.Char(string='Código de Sustento Tributario',
                       required=True, help="", )
    name = fields.Char(
        string='Descripción de Sustento Tributario', required=True, help="", )
    document_type_ids = fields.Many2many(
        'l10n_latam.document.type', string='Document Types', help="", )

...
class L10nEcWithhold(models.Model):
    ...
    _inherit = ['portal.mixin', 'mail.thread', 'mail.activity.mixin', 'ln10_ec.common.document.electronic']
    ...
    def l10n_ec_action_generate_xml_data(self, node_root):
        ...
        SubElement(infoCompRetencion, "tipoIdentificacionSujetoRetenido").text = self.get_identification_type_partner(
        ...
        for line in self.line_ids:
            ...
            SubElement(impuesto, "fechaEmisionDocSustento").text = dateDocSustento.strftime(util_model.get_formato_date())

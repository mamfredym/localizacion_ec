...
class TestModule(common.TransactionCase):
    ...
    def test_data1(self):
        ...
        #2 SUCCESSFULLY CREATED POINT OF EMISSION
        ...
        #3 SUCCESSFULLY CREATED AUTHORIZATION
        ...
        #4 SUCCESSFULLY CREATED DOCUMENT
    ...
    def test_relationship_active_fiel_agency_pofe(self):
        self.assertIs(self.test_pofe1.active, self.test_agency1.active, 'The relationship of the active field of the Agency / PofE is incorrect')
...
#        with self.assertRaises(UserError):
 #           self.env['l10n_ec.sri.authorization'].search([('id', '=', self.test_auth1.id)]).unlink()
  #      # 9 Check impossibility of deleting authorization if there are related invoices
